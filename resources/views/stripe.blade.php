            ...
            <div class="card mt-5">
                ...
                <div class="card-body">
                    ...
                    @php
                        ...
                        $order_info = \App\Models\StripeOrder::where('order_id', $order_id)->first();
                    @endphp
                    ...
                    @endsession
                    <form id='checkout-form' method='post' action="{{ route('stripe.post', $order_info->order_id) }}">   
                        @csrf    
                        ...
                        <button 
                            ...
                            onclick="createToken()">PAY {{$order_info->total}} BDT
                        </button>
                    <form>
                </div>
            </div>
